    ...
    $('.query').click(function () {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.code != 0) {
                    $('.orders_table').html("")
                    $('.orders_table').append("<tr><td colspan='9'>" + '服务器出现问题，请联系管理员' + "</td></tr>")
                    return false
                }

                if (Info.count === 0) {
                    $('.orders_table').html("")
                    $('.orders_table').append("<tr><td colspan='9'>" + '未找到相应内容' + "</td></tr>")
                    return false
                }
                ...
                for (var j = 0 , i = j + 1; j < Info.count; j++ , i++) {
                    ...
                    var matchName = order.bigMatch ? order.bigMatch.bigMatchSerie.name : order.dailyMatch.dailyMatchSerie.name
